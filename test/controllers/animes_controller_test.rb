...
class AnimesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create anime" do
    assert_difference('Anime.count') do
      post animes_url, params: { anime: { episode: @anime.episode, img_url: @anime.img_url, season: @anime.season, summary: @anime.summary, title: @anime.title } }
    end
  ...
  test "should update anime" do
    patch anime_url(@anime), params: { anime: { episode: @anime.episode, img_url: @anime.img_url, season: @anime.season, summary: @anime.summary, title: @anime.title } }
